...
export declare function CadViewerFrame({ title, metadata, download, children, className, style, frameRef, theme, }: CadViewerFrameProps): import("react/jsx-runtime").JSX.Element;
